...
BOARD_RECOVERY_KERNEL_MODULES_LOAD := $(strip $(shell cat $(KERNEL_PATH)/ramdisk/modules.load.recovery))
BOARD_RECOVERY_KERNEL_MODULES := $(wildcard $(KERNEL_PATH)/ramdisk/*.ko)
...
BOARD_RECOVERY_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB)

BOARD_RECOVERY_MKBOOTIMG_ARGS += --board $(BOARD_NAME)
BOARD_RECOVERY_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB)
BOARD_RECOVERY_MKBOOTIMG_ARGS += --pagesize $(BOARD_KERNEL_PAGESIZE)
...
BOARD_RECOVERY_MKBOOTIMG_ARGS += --second_offset $(BOARD_SECOND_OFFSET)
...
# Recovery AVB key (required for non-A/B devices)
...
DEVICE_FRAMEWORK_COMPATIBILITY_MATRIX_FILE := \
   ...
   $(CONFIGS_PATH)/vintf/a15nsxx_framework_compatibility_matrix.xml.xml \
